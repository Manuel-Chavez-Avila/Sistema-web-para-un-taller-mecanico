<!DOCTYPE html>
       ...
       <link rel="shortcut icon" href="imagen/herramienta.png">
		<body>
			<header>
				<h1>Servicios que ofrece el taller mecanico</h1>
  ...
  <a class="navbar-link" href="index.html">Taller</a>
       ...
       <li class="nav-item dropdown">
        ...
        <a class="nav-link" href="CREA TU CITA.php"><i class="fa fa-users" aria-hidden="true"></i>CREA TU CITA</a>
			 ...
			 <article>
				...
				<br>
				<ul>
				 <li><b>Mantenimiento de aire acondicionado automotriz</b></li>
				<img class="centrarimagen"src="imagen/mantenimiento.png"height="200"/>
