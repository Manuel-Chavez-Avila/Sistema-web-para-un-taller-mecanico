<!DOCTYPE html>
    ...
    <head> 
       ...
       <link rel="shortcut icon" href="imagen/cotizar.png">
    <body>
      <header>
        <h1>Crear cita para el taller mecanico</h1>
                ...
                <div class="col-md-12 mx-auto">
                    <form method="POST">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label class="font-weight-bold text-white">Fecha para la cita:</label>
                            <input type="date" name="fecha_cita" class="form-control mt-2" placeholder="Fecha para la cita" required>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label class="font-weight-bold text-white">Hora para la cita:</label>
                            <input type="time" name="hora" class="form-control mt-2" placeholder="Fecha para la cita" required>
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group">
