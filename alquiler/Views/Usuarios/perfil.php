    ...
    <div class="col-lg-5 col-md-5 col-sm-12">
        <div class="card profile-card-3">
            <div class="background-block">
                <img src="https://images.pexels.com/photos/459225/pexels-photo-459225.jpeg?auto=compress&cs=tinysrgb&h=950&w=940" alt="profile-sample1" class="background" />
            </div>
            <div class="profile-thumb-block">
                <img class="rounded" src="  http://localhost/alquiler/Assets/img/users/foto.jpg" width="55">
            </div>
